...
protected:
	...
	/**
	 * @fn	void ModelMesh::readVertexData(aiMesh* mesh, std::vector<pntVertexData>& vertexData, std::vector<unsigned int>& indices);
	 *
	 ...
	 */
	void readVertexData(struct aiMesh* mesh, std::vector<pntVertexData>& vertexData, 
