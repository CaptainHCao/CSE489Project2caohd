...
public:
	...
	/**
	 * @fn	void CameraComponent::addCamera();
	 *
	 * @brief	Adds camera the camera to the list of active cameras and sorts
	 * 			the vector based on the depth values that the cameras contain.
	 */
	void addCamera();
